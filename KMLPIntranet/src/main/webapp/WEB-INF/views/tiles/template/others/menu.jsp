...
<div class="w3-sidebar w3-card-2 w3-center w3-bar-block w3-border-right">
	...
	<a href="${pageContext.request.contextPath}/notice.do"><input type="button" id="input" class="w3-btn w3-round-large w3-blue-grey" value="&#xf274; 공지사항" style="margin-top: 20px"></a>
	<a href="${pageContext.request.contextPath}/approve.do"><input type="button" id="input" class="w3-btn w3-round-large w3-blue-grey" value="&#xf0ea; 전자결재"></a>
