...
<script type="text/javascript">
	...
	function setFocus(){
		if(document.login)document.login.m_id.focus();
	}
...
<body onLoad="setFocus()">
	<div class="w3-center">
		...
		<div class="w3-border- w3-border-light-grey" style="margin-top: 100px">
			<img class="w3-image" src="${pageContext.request.contextPath}/resources/img/kmlp_logo.png" width="250"><br>
		...
		<div class="container" style="margin-top: 120px">
			...
			<sec:authorize access="isAnonymous()">
				<sf:form id="login" name="login" method="post" action="${loginUrl}" onsubmit="return checkValue()">
					<table align="center">
						<tr>
							<th>사원번호</th>
							<td><input type="text" id="m_id" name="m_id" style="width: 200px; height: 32px" tabindex="1"></td>
							<td rowspan="2"><input type="submit" id="submit" class="w3-btn" value="로그인" onclick="submit_click();" tabindex="3"></td>
						</tr>
						<tr>
							<th>비밀번호</th>
							<td><input type="password" id="m_pwd" name="m_pwd" style="width: 200px; height: 32px" tabindex="2"></td>
						</tr>
					</table>
				...
				<div style="margin-top: 20px">
					<a href=""><input type="button" id="find" name="find" class="w3-btn w3-white w3-round-xlarge" value="비밀번호 찾기"></a>
				</div>
			</sec:authorize>
